...
def run_ar_2_covariate_hmm(model_name: str):
    ...
    BASE_MODEL_PATH = "results/models/ar_1_covariate_hmm.pkl"
    ...
    BASE_MODEL_PATH = "results/models/ar_2_hmm.pkl"
    base = load_model(BASE_MODEL_PATH)
...
if __name__ == "__main__":
    model_name = "ar_2_covariate_hmm"
    PATH = f"results/models/{model_name}.pkl"
    model = run_ar_2_covariate_hmm(model_name)
